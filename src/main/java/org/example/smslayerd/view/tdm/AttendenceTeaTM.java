...
public class AttendenceTeaTM {
    ...
    public AttendenceTeaTM(String attendID, String date, String adminID, String teacherID,  ToggleSwitch toggleSwitch,String classID) {
    ...
    public AttendenceTeaTM(DtoAttendenceTea dtoAttendenceTea) {
